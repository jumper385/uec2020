  ...
  <form class="formcontainer" on:submit|preventDefault={onSubmit}>
    ...
    <div class="inputcontainer">
      ...
      <input
        required={true}
        class="textinput"
        bind:value={newschema.firstname}
        name="firstname" />
    </div>
    <div class="inputcontainer">
    ...
    <div class="inputcontainer">
      ...
      <input
        class="textinput"
        bind:value={newschema.profession}
        name="profession" />
    </div>
