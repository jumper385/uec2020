...
{#if credentials != undefined}
  ...
  <button on:click={() => editing = editing == false ? true : false}>Edit Profile</button>
  {:else}
  <h1 style='text-align:center'>Edit Profile</h1>
  <form style='max-width:300pt; margin:0 auto'>
    <div class="inputcontainer">
      <p class="input_title">First Name</p>
      <input class="textinput" bind:value={editvalues.firstname} name="firstname" />
    </div>
    
    <div class="inputcontainer">
      <p class="input_title">Last Name</p>
      <input class="textinput" bind:value={editvalues.lastname} name="lastname" />
    </div>
    ...
    <div class="inputcontainer">
      ...
      <input class="textinput" bind:value={editvalues.profession} name="profession" />
    </div>
