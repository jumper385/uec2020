...
{#if !closed}
  <div
    ...
    class="banner"
    style={banner.message ? null : 'display: None'}>
    <p style="color:white; text-align:left;">
      {banner.message ? null : 'display: None'}
    </p>
    <span on:click={() => (closed = true)} class="banner-close material-icons">
      check_box
    </span>
  </div>
{/if}
